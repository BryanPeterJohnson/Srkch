...
const NAV_ITEMS = [
  {
    ...
    href: "/services",
    links: [
      { id: "1", label: "Personal Care & Daily Living Assistance", slug: "/services/personal-care" },
      { id: "2", label: "Companion & Social Engagement Care", slug: "/services/companion-care" },
      { id: "3", label: "Memory Care & Safety Monitoring", slug: "/services/memory-care" },
      { id: "4", label: "Household & Nutrition Support", slug: "/services/home-nutrition" },
      { id: "5", label: "Family Respite & Caregiver Support", slug: "/services/respite-care" },
      { id: "6", label: "Disability Support Services", slug: "/services/disability-support" },
      { id: "7", label: "Recovery & Post-Hospital Support", slug: "/services/recovery-care" },
      { id: "8", label: "Medication Reminders & Wellness Checks", slug: "/services/medication-wellness" },
      { id: "9", label: "Transportation & Appointment Assistance", slug: "/services/transportation" },
      { id: "10", label: "Pediatric & Child Care Services", slug: "/services/pediatric-care" },
    ],
  },
  {
    label: "About Us",
