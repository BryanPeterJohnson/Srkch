...
export const services = [
  {
    ...
    tagline: "Dignity and independence, every single day —\ncompassionate hands-on help that respects your pace.\nBathing, dressing, grooming, mobility and transfers, handled with patience and care.\nBuilt around your loved one's own routine, so daily living stays comfortable at home.",
    description:
  ...
  },
  {
    ...
    tagline: "Connection that transforms quality of life —\nfriendly company that keeps loneliness at bay.\nConversation, shared meals, walks, errands and visits with a caregiver who shows up.\nRegular companionship that supports emotional well-being and mental health at home.",
  ...
  },
  {
    ...
    tagline: "Specialized, compassionate support for cognitive change —\nfamiliar routines that bring calm and safety home.\nPersonalized help for Alzheimer's, dementia and memory loss, with gentle reassurance.\nWatchful monitoring for fall risks, wandering and changes in condition.",
  ...
  },
  {
    ...
    tagline: "A clean home and nourishing meals —\nthe everyday foundation of health and wellbeing.\nMeal planning, grocery support and safe in-home cooking for every dietary need.\nLight housekeeping and laundry that keep the home safe, tidy and comfortable.",
  ...
  },
  {
    ...
    tagline: "Rest is not a luxury, it's a medical necessity —\nreliable relief so you can step away with confidence.\nA trained caregiver steps into the existing routine while you rest, work or travel.\nCoverage from a few hours a week up to multi-week blocks, with your loved one's day uninterrupted.",
  ...
  },
  {
    ...
    title: "Family Respite & Caregiver Support",
    shortTitle: "Respite Care",
    tagline: "Rest is not a luxury, it's a medical necessity —\nyour child's day stays normal while you recharge.\nCaregivers follow the established routine of meals, hygiene, bedtime, schoolwork and play.\nCoverage from a few hours to overnight and multi-day stays.",
  ...
  },
  {
    ...
    tagline: "A safe bridge from hospital to home —\nsteady support through the highest-risk recovery weeks.\nDaily help with personal care, mobility, meals, medication reminders and follow-up visits.\nNon-clinical support that complements skilled nursing and lowers readmission risk.",
  ...
  },
  {
    ...
    title: "Recovery & Post-Hospital Support",
    shortTitle: "Recovery Care",
    tagline: "A safe bridge from hospital to home —\nback to school, play, and routine at a healthy pace.\nHelp with personal care, feeding, mobility, supervision and follow-up appointments.\nClose coordination with parents and the discharge plan, with prompt updates on any change.",
  ...
  },
  {
    ...
    tagline: "Consistent wellness management, day after day —\ntimely reminders and daily check-ins you can rely on.\nVerbal reminders and routine observation to help take medications on time as directed.\nMissed doses and changes in condition reported promptly to family.",
  ...
  },
  {
    ...
    title: "Medication Reminders & Wellness Checks",
    shortTitle: "Medication & Wellness",
    tagline: "Consistent wellness management, day after day —\nscheduled reminders with every dose documented.\nAge-appropriate observation of self-administration, following your provider's instructions.\nAny missed dose or change in condition reported directly to parents or guardians.",
  ...
  },
  {
    ...
    title: "Transportation & Appointment Assistance",
    shortTitle: "Transportation",
    tagline: "Never miss an appointment that matters —\nsafe, supervised trips with trusted hand-offs every time.\nDoor-to-door transport for school runs, appointments, activities and religious services.\nCaregivers secure mobility equipment and hand off directly to you or authorized adults.",
