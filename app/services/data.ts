...
export const services = [
 ...
 tagline: "Dignity in every moment. Independence every day.\nWe provide compassionate assistance with bathing, dressing, grooming, mobility, transfers, and daily routines. Care is tailored to your loved one's needs and delivered with patience, kindness, and respect, helping them stay comfortable, confident, and independent at home.",    
 description:      "At SRK Care at Home, we provide trusted and compassionate in-home senior care for adults age 65 and older across Maryland. Our caregivers help seniors stay safe, comfortable, and independent at home with hands-on support for bathing, dressing, grooming, toileting, mobility, transfers, and eating. Care is built around each person's own routine and pace, so daily living stays dignified rather than rushed. We support eligible seniors through Maryland Medicaid, LTSS, In-Home Aides Services, Home and Community-Based Services, and long-term caregiving programs, helping families access reliable care so their loved ones can age safely at home.",
    icon: Heart,
  ...
  },
  {
    ...
    title: "Personal Care & Daily Living Assistance",
    shortTitle: "Personal Care",
    tagline: "Dignity and independence, every single day —\nsupport where you want it, autonomy everywhere else.\nHelp with bathing, dressing, grooming, mobility and transfers, on your terms.\nDesigned so you keep running your own day, household and schedule.",
    description:
  ...
  },
  {
    ...
    tagline: "Meaningful connection. A brighter day. A stronger sense of belonging.\nOur compassionate caregivers provide dependable companionship that keeps your loved one engaged and connected at home. From sharing conversation and meals to walks, errands, and favorite activities, every interaction centers on friendship, respect, and meaningful personal connection.",
  ...
  },
  {
    ...
    title: "Companion & Social Engagement Care",
    shortTitle: "Companion Care",
    tagline: "Connection that transforms quality of life —\nstaying tied to the people and routines that matter.\nConversation, shared activities and company to community events, appointments and errands.\nReassurance for family that your relative is never spending long stretches alone.",
    ...
    icon: Users,
    image: "/images/Services/Adults/Companion.jpg",
  ...
  },
  {
    ...
    tagline: "Compassionate support. Familiar routines. Greater peace of mind at home.\nWe provide dependable support for individuals living with Alzheimer's disease, dementia, or memory loss. Our caregivers maintain routines, offer reassurance and supervision, reduce fall and wandering risks, and report changes, creating a safer, calmer home while preserving dignity and independence.",  
  ...
  },
  {
    ...
    tagline: "We help with meal planning, grocery support, safe in-home meal preparation, light housekeeping, and laundry, keeping everyday life comfortable, organized, and supportive of well-being at home.",
    ...
    icon: Home,
    image: "/images/Services/Seniors/Nutrition-Support.png",
    accent: "#E57531",
    accentLight: "#fffbeb",
  ...
  },
  {
    ...
    tagline: "Reliable, compassionate respite care gives family caregivers the freedom to rest, work, attend appointments, or simply recharge with confidence. Our caregivers step seamlessly into your loved one's routine, providing consistent support while preserving comfort, dignity, and continuity at home.",
  ...
  },
  {
    ...
    title: "Family Respite & Caregiver Support",
    shortTitle: "Respite Care",
    tagline: "Rest is not a luxury, it's a medical necessity —\ncontinuity of care while you take the break you need.\nTemporary relief that keeps personal care, mobility, meals and supervision on track.\nSo the person you care for experiences continuity, not disruption.",
  ...
  },
  {
    ...
    title: "Family Respite & Caregiver Support",
    shortTitle: "Respite Care",
    tagline: "Compassionate care that helps your child feel safe, supported, and at home.\nOur caregivers support children with meals, hygiene, schoolwork, play, bedtime, and daily routines. We follow each child's preferences and schedule, providing attentive care at home while giving families time to rest, work, or manage responsibilities.",
  ...
  },
  {
    ...
    tagline: "Maximizing capability, comfort, and independence —\ntailored support built around your goals and daily life.\nHelp with personal care, mobility, medication reminders, meals and household tasks.\nCognitive and community activities that build independence and quality of life.",
  ...
  },
  {
    ...
    tagline: "A confident transition from hospital to home.\nWe provide dependable, non-clinical support after discharge, helping with personal care, mobility, meals, medication reminders, and daily routines. Our caregivers work alongside the existing healthcare team to promote a safe, comfortable recovery at home.",
  ...
  },
  {
    ...
    title: "Recovery & Post-Hospital Support",
    shortTitle: "Recovery Care",
    tagline: "A safe bridge from hospital to home —\nregain strength and get back to life without setbacks.\nDaily support with personal care, mobility, meals, medication reminders and errands.\nNon-medical help that gets you back to work and normal routines at a healthy pace.",
  ...
  },
  {
    ...
    title: "Recovery & Post-Hospital Support",
    shortTitle: "Recovery Care",
    tagline: "Helping your child transition home with comfort, confidence, and care.\nOur caregivers support children with meals, hygiene, schoolwork, play, bedtime, and daily routines. We follow each child's preferences and schedule, providing attentive in-home care while giving parents and family caregivers time to rest, work, or manage responsibilities.",
  ...
  },
  {
    ...
    tagline: "Our caregivers provide dependable medication reminders and wellness checks to help clients follow their prescribed schedule as directed. We also watch for changes in condition and promptly report missed doses or concerns to the family or designated care team.",
  ...
  },
  {
    ...
    title: "Medication Reminders & Wellness Checks",
    shortTitle: "Medication & Wellness",
    tagline: "Consistent wellness management, day after day —\ngentle reminders that keep your routine on track.\nDaily check-ins and routine support to take medications on time as directed.\nFewer missed doses, better wellness and real peace of mind for families.",
  ...
  },
  {
    ...
    title: "Medication Reminders & Wellness Checks",
    shortTitle: "Medication & Wellness",
    tagline: "Our caregivers support children with meals, hygiene, schoolwork, play, bedtime, and daily routines. We follow each child's preferences and schedule, providing attentive care at home while giving families time to rest, work, or manage responsibilities.",
  ...
  },
  {
    ...
    tagline: "Never miss an appointment that matters —\ndoor-to-door rides with an escort who stays by your side.\nSafe transport to medical visits, therapy, work, errands and community activities.\nUnlike a taxi or rideshare, your caregiver walks you in, helps at check-in and stays.",
  ...
  },
  {
    ...
    title: "Transportation & Appointment Assistance",
    shortTitle: "Transportation",
    tagline: "We provide dependable transportation and caregiver support for children traveling to school, appointments, activities, and community or religious programs. Caregivers offer attentive supervision, mobility support, and safe hand-offs to parents, guardians, or authorized adults.",
 ...
 image: "/images/Services/Childrens/Transportation.jpg",
  ...
  },
  {
    ...
    tagline: "Nurturing the next generation with expert, attentive care —\nsafe, supported days that give families peace of mind.\nHelp with daily routines, personal care, meals, mobility and age-appropriate activities.\nExperienced support for special needs, disabilities, developmental delays and autism.",
    ...
    icon: Baby,
    image: "/images/Services/Childrens/Pediatric-Child.png",
    accent: "#E57531",
    accentLight: "#faf5ff",
    category: "Pediatric",
